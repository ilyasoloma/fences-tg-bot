...
class Config:
    ...
    ADD_USER_ROLE = 'Кого ты хочешь добавить?'
    ENTER_ADD_USERNAME = "Введи username (без @):"
    ENTER_ADD_ALIAS = "Введи отображаемое имя:"
    ADDING_USER = 'Добавление участника...'
    SET_DATETIME_MSG = 'Введи дату и время в формате ДД.ММ.ГГГГ ЧЧ:ММ:СС'
